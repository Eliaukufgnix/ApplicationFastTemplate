...
namespace Service
{
    public interface IBaseService<T> where T : class
    {
        ...
        /// <returns></returns>
        List<T> Pagination(int PageIndex, int PageSize, out int TotalCount, Expression<Func<T, int>> OrderBy = null, bool IsOrder = true, Expression<Func<T, bool>> WhereLambda = null);
        ...
        /// <param name="IsOrder">是否正序</param>
        /// <returns></returns>
        List<T> Pagination<TKey>(int PageIndex, int PageSize, out int TotalCount, Expression<Func<T, TKey>> OrderBy, bool IsOrder = true, Expression<Func<T, bool>> WhereLambda = null);
    }
}